...
- When a TGS is requested, an event log with ID <span style="color:rgb(255, 255, 0)">4769</span> is generated. However, AD also generates the same event ID whenever a user attempts to connect to a service